...
const startSync = trigger({
  ...
  config: {
    name: 'Start Sync',
    position: [-620, 0],
    parameters: { httpMethod: 'POST', path: 'csp-autotask-sync-test', responseMode: 'onReceived', options: {} }
  },
  output: [{ body: {} }]
});
...
export default workflow('kantanna-csp-03-sync-test', '03 · Autotask Sync · TEST')
  .add(startSync)
  .to(autotaskConfig)
  .to(fetchSyncLines)
  .to(prepareLines)
